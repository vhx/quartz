...
Q.components.guide.styleguide.ui.icons_list = function() { return [{"name":"activity"},{"name":"add-member"},{"name":"amex-card"},{"name":"alert"},{"name":"align"},{"name":"android-workmark"},{"name":"angle-left"},{"name":"angle-down"},{"name":"angle-right"},{"name":"android"},{"name":"api"},{"name":"apple"},{"name":"apps"},{"name":"angle-up"},{"name":"arrow-left"},{"name":"arrow-down"},{"name":"arrow-up"},{"name":"arrow-right"},{"name":"audio"},{"name":"ban"},{"name":"briefcase"},{"name":"bell"},{"name":"calendar"},{"name":"camera"},{"name":"caret-down"},{"name":"card"},{"name":"caret-left"},{"name":"caret-right"},{"name":"caret-up"},{"name":"cassette"},{"name":"cassette-frown"},{"name":"check"},{"name":"chevron-down"},{"name":"chevron-left"},{"name":"chevron-right"},{"name":"chrome"},{"name":"chevron-up"},{"name":"clapboard"},{"name":"clock"},{"name":"code"},{"name":"cog"},{"name":"comment"},{"name":"collection"},{"name":"comments"},{"name":"csv"},{"name":"currency"},{"name":"diners-card"},{"name":"desktop"},{"name":"discover-card"},{"name":"doc"},{"name":"download"},{"name":"download-alt"},{"name":"dropbox"},{"name":"edit"},{"name":"ellipsis"},{"name":"ellipsis-vertical"},{"name":"envelope-sealed"},{"name":"envelope"},{"name":"external-link"},{"name":"eye"},{"name":"followers"},{"name":"gift"},{"name":"facebook"},{"name":"grid"},{"name":"globe"},{"name":"help"},{"name":"hi"},{"name":"home"},{"name":"instagram"},{"name":"invoice"},{"name":"ios"},{"name":"justify"},{"name":"key"},{"name":"jcb-card"},{"name":"link"},{"name":"list"},{"name":"lock"},{"name":"marker"},{"name":"mastercard-card"},{"name":"media"},{"name":"member"},{"name":"money-card"},{"name":"money"},{"name":"paypal-card"},{"name":"money-circle"},{"name":"pic"},{"name":"plus-thin"},{"name":"play-outline"},{"name":"play"},{"name":"plus"},{"name":"popular"},{"name":"power"},{"name":"printer"},{"name":"product"},{"name":"random"},{"name":"question"},{"name":"refresh"},{"name":"referral"},{"name":"revert"},{"name":"reply"},{"name":"search"},{"name":"roku-wordmark"},{"name":"roku"},{"name":"tag"},{"name":"star"},{"name":"sliders"},{"name":"star-outline"},{"name":"todo"},{"name":"transaction"},{"name":"tags"},{"name":"trash"},{"name":"tv"},{"name":"tumblr"},{"name":"tvos"},{"name":"upload-alt"},{"name":"twitter"},{"name":"upload-alt-blue"},{"name":"upload"},{"name":"vhx"},{"name":"vhs"},{"name":"vimeovhx-light"},{"name":"visa-card"},{"name":"window"},{"name":"vimeovhx-dark"},{"name":"x"},{"name":"xmas-tree"},{"name":"upload-vimeo"}]; };Q.components.guide.styleguide.ui.images = {};

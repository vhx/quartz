        ...
        component: {
          view: function() {
            return m('div', [
              ...
              m('button.btn-vimeo-blue.margin-right-small.margin-bottom-small', 'Vimeo Blue'),
              m('button.btn-vimeo-secondary.margin-right-small.margin-bottom-small', 'Vimeo Secondary'),
              m('button.btn-vimeo-secondary-outline.margin-right-small.margin-bottom-small', 'Vimeo Secondary Outline')
            ]);
          }
        }
      }),
        ...
        component: {
          view: function() {
            return m('div', [
              ...
              m('button.btn-vimeo-blue.is-processing.margin-right-small.margin-bottom-small', 'Button'),
              m('button.btn-vimeo-secondary.is-processing.margin-right-small.margin-bottom-small', 'Button'),
              m('button.btn-vimeo-secondary-outline.is-processing.margin-right-small.margin-bottom-small', 'Button')
            ]);
          }
        }
      }),
        ...
        component: {
          view: function() {
            return m('div', [
              ...
              m('button.btn-dropdown-vimeo-blue.margin-right-small.margin-bottom-small', 'Dropdown'),
              m('button.btn-dropdown-vimeo-secondary.margin-right-small.margin-bottom-small', 'Dropdown'),
              m('button.btn-dropdown-vimeo-secondary-outline.margin-right-small.margin-bottom-small', 'Dropdown'),
          ...
          view: function() {
            return m('div', [
              ...
              m('div.btn-group.margin-bottom-medium', [
               ...
               m('div.btn-group.margin-bottom-medium', [
                m('button.btn-vimeo-blue.small-thirds.is-selected', 'Button 1'),
                m('button.btn-vimeo-blue.small-thirds', 'Button 2'),
                m('button.btn-vimeo-blue.small-thirds', 'Button 3')
              ]),
              m('div.btn-group.margin-bottom-medium', [
                m('button.btn-vimeo-secondary.small-thirds.is-selected', 'Button 1'),
                m('button.btn-vimeo-secondary.small-thirds', 'Button 2'),
                m('button.btn-vimeo-secondary.small-thirds', 'Button 3')
              ]),
              m('div.btn-group.margin-bottom-medium', [
                m('button.btn-vimeo-secondary-outline.small-thirds.is-selected', 'Button 1'),
                m('button.btn-vimeo-secondary-outline.small-thirds', 'Button 2'),
                m('button.btn-vimeo-secondary-outline.small-thirds', 'Button 3')
              ]),

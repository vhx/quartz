...
Q.components.guide.styleguide.ui.icons_list = function() { return [{"name":"activity"},{"name":"add-member"},{"name":"alert"},{"name":"align"},{"name":"amex-card"},{"name":"android-workmark"},{"name":"android"},{"name":"angle-down"},{"name":"angle-left"},{"name":"angle-right"},{"name":"angle-up"},{"name":"api"},{"name":"apple"},{"name":"apps"},{"name":"arrow-down"},{"name":"arrow-left"},{"name":"arrow-right"},{"name":"arrow-up"},{"name":"audio"},{"name":"ban"},{"name":"bell"},{"name":"briefcase"},{"name":"calendar"},{"name":"card"},{"name":"camera"},{"name":"caret-down"},{"name":"caret-right"},{"name":"caret-left"},{"name":"cassette-frown"},{"name":"caret-up"},{"name":"cassette"},{"name":"check"},{"name":"chevron-down"},{"name":"chevron-left"},{"name":"chevron-right"},{"name":"chevron-up"},{"name":"chrome"},{"name":"clapboard"},{"name":"clock"},{"name":"code"},{"name":"cog"},{"name":"collection"},{"name":"comment"},{"name":"comments"},{"name":"csv"},{"name":"currency"},{"name":"desktop"},{"name":"diners-card"},{"name":"discover-card"},{"name":"doc"},{"name":"download-alt"},{"name":"download"},{"name":"dropbox"},{"name":"edit"},{"name":"ellipsis-vertical-vimeo"},{"name":"ellipsis-vertical"},{"name":"ellipsis-vimeo"},{"name":"ellipsis"},{"name":"envelope-sealed"},{"name":"envelope"},{"name":"external-link"},{"name":"eye"},{"name":"facebook"},{"name":"gift"},{"name":"followers"},{"name":"globe"},{"name":"grid"},{"name":"help"},{"name":"hi"},{"name":"home"},{"name":"invoice"},{"name":"instagram"},{"name":"ios"},{"name":"jcb-card"},{"name":"justify"},{"name":"key"},{"name":"link"},{"name":"list"},{"name":"lock"},{"name":"marker"},{"name":"mastercard-card"},{"name":"media"},{"name":"member"},{"name":"money-card"},{"name":"money-circle"},{"name":"money"},{"name":"paypal-card"},{"name":"pic"},{"name":"play-outline"},{"name":"play"},{"name":"plus-thin"},{"name":"plus"},{"name":"popular"},{"name":"power"},{"name":"printer"},{"name":"product"},{"name":"question"},{"name":"random"},{"name":"referral"},{"name":"refresh"},{"name":"reply"},{"name":"revert"},{"name":"roku-wordmark"},{"name":"roku"},{"name":"search"},{"name":"sliders"},{"name":"star-outline"},{"name":"tag"},{"name":"star"},{"name":"todo"},{"name":"tags"},{"name":"transaction"},{"name":"trash"},{"name":"tumblr"},{"name":"tvos"},{"name":"tv"},{"name":"twitter"},{"name":"upload-alt-blue"},{"name":"upload-alt"},{"name":"upload-vimeo"},{"name":"upload"},{"name":"vhs"},{"name":"vhx"},{"name":"vimeovhx-dark"},{"name":"vimeovhx-light"},{"name":"visa-card"},{"name":"window"},{"name":"xmas-tree"},{"name":"x"}]; };Q.components.guide.styleguide.ui.images = {};

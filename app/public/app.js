...
Q.components.guide.styleguide.ui.icons_list = function() { return [{"name":"activity"},{"name":"add-member"},{"name":"alert"},{"name":"align"},{"name":"amex-card"},{"name":"android-workmark"},{"name":"angle-down"},{"name":"android"},{"name":"angle-left"},{"name":"angle-right"},{"name":"angle-up"},{"name":"api"},{"name":"apple"},{"name":"apps"},{"name":"arrow-down"},{"name":"arrow-left"},{"name":"arrow-right"},{"name":"audio"},{"name":"arrow-up"},{"name":"ban"},{"name":"bell"},{"name":"briefcase"},{"name":"camera"},{"name":"calendar"},{"name":"card"},{"name":"caret-down"},{"name":"caret-left"},{"name":"caret-right"},{"name":"caret-up"},{"name":"cassette-frown"},{"name":"cassette"},{"name":"check"},{"name":"chevron-down"},{"name":"chevron-left"},{"name":"chevron-right"},{"name":"chevron-up"},{"name":"chrome"},{"name":"clapboard"},{"name":"clock"},{"name":"code"},{"name":"cog"},{"name":"collection"},{"name":"comment"},{"name":"comments"},{"name":"csv"},{"name":"currency"},{"name":"desktop"},{"name":"diners-card"},{"name":"discover-card"},{"name":"doc"},{"name":"download-alt"},{"name":"download"},{"name":"dropbox"},{"name":"edit"},{"name":"ellipsis-vertical"},{"name":"ellipsis"},{"name":"envelope-sealed"},{"name":"envelope"},{"name":"external-link"},{"name":"eye"},{"name":"facebook"},{"name":"followers"},{"name":"gift"},{"name":"globe"},{"name":"grid"},{"name":"help"},{"name":"hi"},{"name":"home"},{"name":"instagram"},{"name":"invoice"},{"name":"ios"},{"name":"justify"},{"name":"jcb-card"},{"name":"key"},{"name":"link"},{"name":"list"},{"name":"lock"},{"name":"marker"},{"name":"mastercard-card"},{"name":"media"},{"name":"money-card"},{"name":"member"},{"name":"money-circle"},{"name":"money"},{"name":"pic"},{"name":"paypal-card"},{"name":"play-outline"},{"name":"play"},{"name":"plus-thin"},{"name":"plus"},{"name":"popular"},{"name":"power"},{"name":"printer"},{"name":"product"},{"name":"question"},{"name":"random"},{"name":"referral"},{"name":"refresh"},{"name":"revert"},{"name":"reply"},{"name":"roku"},{"name":"search"},{"name":"sliders"},{"name":"star-outline"},{"name":"roku-wordmark"},{"name":"star"},{"name":"tags"},{"name":"todo"},{"name":"tag"},{"name":"transaction"},{"name":"trash"},{"name":"tumblr"},{"name":"tv"},{"name":"tvos"},{"name":"twitter"},{"name":"vhs"},{"name":"vhx"},{"name":"vimeovhx-dark"},{"name":"upload-alt"},{"name":"upload"},{"name":"vimeovhx-light"},{"name":"visa-card"},{"name":"window"},{"name":"xmas-tree"},{"name":"x"},{"name":"upload-alt-blue"},{"name":"upload-vimeo"}]; };Q.components.guide.styleguide.ui.images = {};

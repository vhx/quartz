          ...
          view: function() {
            return m('div', [
              m('span.inline.padding-right-small', [
                m('span.new-avatar.color-teal.avatar--small', [
                  m('span.default-avatar', 'A'),
                  m('span.avatar-user.user-avatar')
                ])
              ]),
              m('span.inline.padding-right-small', [
                m('span.new-avatar.color-teal.avatar--medium', [
                  m('span.default-avatar', 'A'),
                  m('span.avatar-user.user-avatar', {
                    style: {
              ...
              m('span.inline.padding-right-small', [
                m('span.new-avatar.color-teal.avatar--large', [
                  m('span.default-avatar', 'A'),
                  m('span.avatar-user.user-avatar', {
                    style: {
              ...
              m('span.inline.padding-right-small', [
                m('span.new-avatar.color-teal.avatar--xlarge', [
                  m('span.default-avatar', 'A'),
                  m('span.avatar-user.user-avatar', {
                    style: {
